...
export function OrderDetails() {
  const { burgerDataState, burgerConstructorIngredients, orderState } = useSelector(state => {
    return state
  });
 ...
 if (orderState.isLoading) {
    ...
    return (
      !burgerDataState.isLoading && orderState.orderNumber && burgerConstructorIngredients.bun
        ? <div className={orderDetailsStyle.wrapper}>
